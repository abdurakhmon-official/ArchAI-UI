...
export async function generateMetadata(props: PageProps<'/[locale]/admin/leads'>) {
...
export default async function AdminLeadsPage(props: PageProps<'/[locale]/admin/leads'>) {
  const { locale } = await props.params;
