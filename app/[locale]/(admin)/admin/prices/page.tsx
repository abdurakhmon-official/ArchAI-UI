...
export async function generateMetadata(props: PageProps<'/[locale]/admin/prices'>) {
...
export default async function AdminPricesPage(props: PageProps<'/[locale]/admin/prices'>) {
  const { locale } = await props.params;
