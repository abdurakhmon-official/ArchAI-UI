...
export async function generateMetadata(props: PageProps<'/[locale]/admin/projects'>) {
...
export default async function AdminProjectsPage(props: PageProps<'/[locale]/admin/projects'>) {
  const { locale } = await props.params;
