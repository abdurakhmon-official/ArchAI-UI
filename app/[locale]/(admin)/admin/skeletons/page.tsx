...
export async function generateMetadata(props: PageProps<'/[locale]/admin/skeletons'>) {
...
export default async function AdminSkeletonsPage(props: PageProps<'/[locale]/admin/skeletons'>) {
  const { locale } = await props.params;
