...
export async function generateMetadata(props: PageProps<'/[locale]/admin/styles'>) {
...
export default async function AdminStylesPage(props: PageProps<'/[locale]/admin/styles'>) {
  const { locale } = await props.params;
