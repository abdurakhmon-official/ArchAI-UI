...
export async function generateMetadata(props: PageProps<'/[locale]/admin/xona-turlari'>) {
...
export default async function AdminRoomTypesPage(props: PageProps<'/[locale]/admin/xona-turlari'>) {
  const { locale } = await props.params;
