...
export async function generateMetadata(props: PageProps<'/[locale]/parolni-unutdim'>) {
...
export default async function ForgotPasswordPage(props: PageProps<'/[locale]/parolni-unutdim'>) {
  const { locale } = await props.params;
