...
export async function generateMetadata(props: PageProps<'/[locale]/reset-password/[token]'>) {
...
export default async function ResetPasswordPage(props: PageProps<'/[locale]/reset-password/[token]'>) {
