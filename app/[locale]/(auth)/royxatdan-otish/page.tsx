...
export async function generateMetadata(props: PageProps<'/[locale]/royxatdan-otish'>) {
...
export default async function SignUpPage(props: PageProps<'/[locale]/royxatdan-otish'>) {
  const { locale } = await props.params;
