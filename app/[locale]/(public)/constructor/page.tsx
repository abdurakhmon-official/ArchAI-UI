...
export async function generateMetadata(props: PageProps<'/[locale]/constructor'>) {
...
export default async function ConstructorPage(props: PageProps<'/[locale]/constructor'>) {
  const { locale } = await props.params;
