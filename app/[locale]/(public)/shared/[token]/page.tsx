...
export async function generateMetadata(props: PageProps<'/[locale]/shared/[token]'>) {
...
export default async function SharedProjectPage(props: PageProps<'/[locale]/shared/[token]'>) {
