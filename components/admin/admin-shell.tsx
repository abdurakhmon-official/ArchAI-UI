...
const NAV = [
  ...
  { href: '/admin/narxlar', key: 'prices', icon: Coins },
  { href: '/admin/xona-turlari', key: 'roomTypes', icon: DoorOpen },
  { href: '/admin/uslublar', key: 'styles', icon: Palette },
  { href: '/admin/tom-uslublari', key: 'roofStyles', icon: Triangle },
  { href: '/admin/andozalar', key: 'skeletons', icon: Ruler },
  { href: '/admin/loyihalar', key: 'projects', icon: FolderOpen },
  { href: '/admin/blog', key: 'blog', icon: Newspaper },
  { href: '/admin/savollar', key: 'faq', icon: MessageCircleQuestion },
  { href: '/admin/murojaatlar', key: 'leads', icon: Inbox },
  { href: '/admin/media', key: 'media', icon: ImageIcon },
  { href: '/admin/tariflar', key: 'plans', icon: CreditCard },
  { href: '/admin/foydalanuvchilar', key: 'users', icon: Users },
  { href: '/admin/jurnal', key: 'audit', icon: FileClock },
